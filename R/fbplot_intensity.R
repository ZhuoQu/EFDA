## Description of fbplot_intensity.R.
## This function plots a central region first and adds the sparseness intensity in the central region
##
...
fbplot_intensity <- function(time_index, xrange,
  ...
  sparse_medindex <- which(is.na(subsparse[, med_index])) ## index where there are observations in the median curves
