## Description of fbplot_polygon.R.
## add the central region polygon in an existing figure, showing the missingness proportion area in grey,
## and observed proportion area in magenta.
